...
import 'package:flutter_application_1/view/activity_tracker/activity_tracker_screen.dart';
import 'package:flutter_application_1/view/finish_workout/finish_workout_screen.dart';
import 'package:flutter_application_1/view/home/widgets/workout_row.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  // Added state variable to hold the user's name
  ...
  void _loadUserName() {
    ...
    // Get the display name, fallback to email, or 'User'
    // This retrieves the name that was set during sign up (displayName)
    final String userName = user?.displayName ?? user?.email ?? "User";

    // Update the state to display the name
    // setState is called to rebuild the widget and display the name
    setState(() {
      _userName = userName;
    });
  }
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    // --- Modified Column to display dynamic name ---
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text(
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    var style = TextStyle(color: AppColors.grayColor, fontSize: 12);
    Widget text;
    switch (value.toInt()) {
      case 1:
