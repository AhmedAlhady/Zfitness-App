...
import 'package:flutter_application_1/view/activity/widgets/upcoming_workout_row.dart';
import 'package:flutter_application_1/view/activity/widgets/what_train_row.dart';
...
class _ActivityScreenState extends State<ActivityScreen> {
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder:
                                      (context) =>
                                          const WorkoutScheduleView(), // Replace with the actual widget or class
                                ),
                              );
                            },
                          ),
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    var style = TextStyle(color: AppColors.whiteColor, fontSize: 12);
    Widget text;
    switch (value.toInt()) {
      case 1:
